...
<section class="content">
	<div class="box box-danger">
		...
		<form:form method="POST" modelAttribute="b2breg"
			action="${pageContext.request.contextPath}/b2b/add-franchise-registration"
			autocomplete="off">
			<form:hidden id="regType" path="regType" value="FR"/>
			<div class="row">
				<div class="box-body">
					<%-- <div class="form-group col-sm-3">
							...
							<form:select path="regType" id="regType" class="form-control">
								...
								<form:option value="OUTWARD">Outward</form:option>
							</form:select>
						</div>
					<div class="form-group col-sm-3">
						<label for="Country Code">Lab Code :</label>
						<form:input type="text" path="labCode" id="labCode"
							class="form-control" />
					</div> --%>
					<div class="form-group col-sm-3">
