...
<section class="content">
	<div class="box box-danger">
		<div class="box-header with-border">
			...
			<!-- click to open inquiry form  -->
				<button type="button" class="btn btn-box-tool" data-toggle="tooltip"
					...
					<a href="${pageContext.request.contextPath}/appointment/view-appointment-page"><i class="fa fa-plus"></i>
						 View Appointments</a>
				</button>
			</div>
		</div>
		...
		<form:form method="POST"
				action=""
				modelAttribute="appointment" autocomplete="off">
		<div class="row">
			<div class="box-body">
		...
		<div class="row">
			<div class="box-body">
				...
				<div class="form-group col-sm-3">
					...
					<label for="Country Code">Number of test selected :</label>
					<form:input type="text" path=""
						class="form-group form-control" readonly="true" value="0"/>
				
					<label for="Country Code">Total amount :</label>
					<form:input type="text" path=""
						class="form-group form-control" readonly="true" value="0"/>
				
					<label for="Country Code">Discount (if any) :</label>
					<form:input type="text" path=""
						class="form-group form-control"/>
					<label for="Country Code">Paid amount :</label>
					<form:input type="text" path=""
						class="form-group form-control"/>
					<label for="Country Code">Balance amount :</label>
					<form:input type="text" path=""
						class="form-group form-control" readonly="true" value="0"/>
